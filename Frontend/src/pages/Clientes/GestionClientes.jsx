          ...
          <Row>
            ...
            <Row className="justify-content-center mt-4">
              <Col style={{ marginTop: '30px' }}>
                <Form.Select onChange={handleActivosFilterChange} value={activosFilter} style={{ width: '200px' }}>
            ...
            <Row className="justify-content-center mt-2">
              <Col style={{ marginTop: '20px' }}>
                <Form.Select onChange={handleFormaPagoFilterChange} value={formaPagoFilter} style={{ width: '200px' }}>
                  <option value="all">Forma de Pago: Todas</option>
